...
class CustomRequester:
    ...
    """
    # Это класс, который предоставляет универсальный интерфейс для выполнения запросов
    base_headers = {
    ...
    def send_request(self, method, endpoint, data=None, params=None, expected_status=200, need_logging=True):
        ...
        :param params: Параметры фильтрации для GET MOVIES
    ...
    # Дополняет заголовки запроса. Например, если требуется добавить токен аутентификации
