...
class BasePage(PageAction):
    ...
    def __init__(self, page):
        ...
        self.main_page_link = page.get_by_role("link", name="Cinescope")
    ...
    def go_to_main_page(self):
        ...
        self.wait_redirect_for_url(self.home_url, timeout = 10000)

    @allure.step("Переход на страницу 'Все фильмы' из шапки сайта")
    def go_to_all_movies(self):
        self.all_movies_link.click()
        self.wait_redirect_for_url(f"{self.home_url}movies", timeout = 10000)